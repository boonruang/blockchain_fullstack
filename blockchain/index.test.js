...
describe('Blockchain', () => {
  ...
  describe('isValidChain()', () => {
    ...
    describe('when the chain starts with the genesis block and has multiple blocks', () => {
      beforeEach(() => {
        ...
        blockchain.addBlock({ data: 'Battester Galactica' })
      })
  ...
  describe('validTransactionData ()', () => {
    ...
    describe('and the transaction data has at least one mulformed outputMap', () => {
      ...
      describe('and the transaction data has at least one mulformed input', () => {
        it('returns false', () => {})
      })
